...
Lit e2_funding_<label>.json (--funding), ecrit e3_splits_<label>.json (--out).

Validite : le rapport refuse de conclure "aucun decoupage" si des geneses manquent. Le verdict est
alors `echec_de_mesure`, et il est nomme comme tel.
