...
pour le signataire et variation negative de son solde SOL, ce qui distingue les acheteurs des
vendeurs et du createur. Genese de la courbe non atteinte = ordre des premiers acheteurs non
fiable, et le script le signale.

Ecrit e1_buyers_<label>.json dans --outdir.

Usage : python3 etape1_premiers_acheteurs.py --mint <MINT> --curve <BONDING_CURVE> --label OPTIMUS
"""
