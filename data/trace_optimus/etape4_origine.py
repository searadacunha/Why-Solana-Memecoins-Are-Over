...
Prend en graines les bailleurs identifies a l'etape 3, ecrit e4_origine_<label>.json.

Ces bailleurs ont eux-memes ete finances. On remonte de generation en generation jusqu'a rencontrer
un terminal connu (service de swap, echange, pont). G2Y
(G2YxRa6wt1qePMwfJzdXZG62ej4qaTC7YURzuh2Lwd3t) est le terminal qui interesse l'enquete.

Methode : pour chaque adresse, pagination jusqu'a la genese (drapeau rendu), puis lecture des N plus
anciennes transactions et des N plus recentes avant la date du token. Les entrees sont mesurees par
delta de solde. Toute apparition d'un terminal connu parmi les contreparties vues est signalee, pas
