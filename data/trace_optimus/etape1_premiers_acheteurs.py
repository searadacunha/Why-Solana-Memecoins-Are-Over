...
Prend un mint et sa courbe de bonding, ecrit e1_buyers_<label>.json.
...
Piege : si la genese de la courbe n'est pas atteinte, l'ordre des premiers acheteurs n'est pas
fiable. Le script le signale et ne le corrige pas.
